...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #222222;">
    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
	      ...
	      <tr>
          <td valign="middle" class="hero bg_white" style="background-image: url('https://raw.githubusercontent.com/adelutfi/Studio-Musik/master/public/assets/landing/img/bg/header-bg.jpg'); background-size: cover; height: 400px;">
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: center;">
                      	<p>&copy; 2020 Stuio Musik Tegal. All Rights Reserved</p>
                      </td>
                    </tr>
                  </table>
                </td>
